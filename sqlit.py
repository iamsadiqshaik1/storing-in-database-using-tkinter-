...
label_0 = Label(root, text="Registration form by @mrtec_hy",width=25,font=("bold", 20))
...
list1 = ['India','UK','Nepal','USA','South Africa','South korea'];
...
Checkbutton(root, text="python", variable=var2).place(x=280,y=330)
Checkbutton(root, text="java", variable=var3).place(x=350,y=330)
Checkbutton(root, text="C++", variable=var4).place(x=410,y=330)
